        ...
        <div className="p-6 space-y-4">
            ...
            <div>
                ...
                <ul className="space-y-1 text-gray-300 list-none p-0">
                    <li className="flex items-start"><span className="flex items-center w-16 flex-shrink-0"><Star className="w-4 h-4 mr-1 text-yellow-400"/></span> — достойная фотография;</li>
