...
- **Раскрытое состояние**:
    ...
    - Раскрытая группа имеет фон и рамку, а все остальные элементы ленты приглушаются с помощью оверлея, создавая "модальный" эффект.
...
- **Навигация по группам**:
    ...
    - **Индикатор и "проваливание"**: В режиме просмотра у фото из группы отображается её название и кнопка "Изменить выбор", которая закрывает просмотр и раскрывает соответствующую группу в ленте.
