...
- 4-я и 5-я звезды визуально отличаются (пунктирная обводка, красный цвет при наведении на десктопе).
...
- **Отображение оценок**:
    ...
    - Красный крестик для сброса оценки появляется только при наведении мыши на блок с оценками.
