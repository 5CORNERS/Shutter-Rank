...
- **Экспорт в HTML**:
    ...
    - Формат файла соответствует предоставленному образцу, включая специальную обработку подписей (например, `описание || автор`) и встроенный скрипт для адаптивной верстки подписей.
